...
public class DiscogsSearchByReleaseTitleStrategy
{
    ...
    public DiscogsSearchByReleaseTitleStrategy(IDiscogRepository discogService, IReleaseAlbumRepository releaseAlbumRepository, ILogger logger)
    {
    ...
    public async Task<OperationResult> StartAsync(string? releaseTitle, CancellationToken cancellationToken)
    {
